...
class __TwigTemplate_4622ce8869fbf90e375431601214c494625a4f2eb4f639f65c076117f32621dd extends \Twig\Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dateCountPair"]) {
            ...
            echo "\" data-count=\"";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "count", []), "html", null, true);
            echo "\" data-starred=\"";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "starred", []), "html", null, true);
            echo "\"
              ";
            // line 6
            if (($this->getAttribute((isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "count", []) == 0)) {
                echo "title=\"";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Annotations_AddAnnotationsFor", (isset($context["date"]) ? $context["date"] : $this->getContext($context, "date"))]), "html", null, true);
                echo "\"
              ";
            } elseif (($this->getAttribute(            // line 7
(isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "count", []) == 1)) {
                echo "title=\"";
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Annotations_AnnotationOnDate", (isset($context["date"]) ? $context["date"] : $this->getContext($context, "date")), \Piwik\piwik_escape_filter($this->env, $this->getAttribute(                // line 8
(isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "note", []), "html_attr")]);
                echo "
";
                // line 9
              ...
              ";
                ...
                // line 10
                echo "}title=\"";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Annotations_ViewAndAddAnnotations", (isset($context["date"]) ? $context["date"] : $this->getContext($context, "date"))]), "html", null, true);
                echo "\"";
            }
            echo ">
...
", "@Annotations/getEvolutionIcons.twig", "/var/www/analytics/plugins/Annotations/templates/getEvolutionIcons.twig");
    }
}
