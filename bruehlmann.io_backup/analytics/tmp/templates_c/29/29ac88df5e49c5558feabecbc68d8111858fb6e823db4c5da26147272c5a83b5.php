...
class __TwigTemplate_422381b927fc6c01e6cb9946ef42421466217c27b9229c3f54d66346de1df9c5 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerType"], "method"), "html", null, true);
        echo "\">
    ";
        // line 2
        if (($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerType"], "method") == "website")) {
            // line 3
            echo "        <span>";
        ...
        <a href=\"";
            // line 4
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('safelink')->getCallable(), [$this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerUrl"], "method")]), "html_attr");
            echo "\" rel=\"noreferrer noopener\" target=\"_blank\" class=\"visitorLogTooltip\" title=\"";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerUrl"], "method"), "html", null, true);
            echo "\"
           style=\"text-decoration:underline;\">
            ";
            // line 6
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerName"], "method"), "html", null, true);
            echo "
        </a>
    ";
        }
        // line 9
        echo "    ";
        if (($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerType"], "method") == "campaign")) {
            // line 10
            echo "        <span>";
            ...
            ";
            // line 11
            if ( !twig_test_empty($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerKeyword"], "method"))) {
                echo " - ";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerKeyword"], "method"), "html", null, true);
            }
            echo "</span>
    ";
        }
        // line 13
        echo "    ";
        if (($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerType"], "method") == "social")) {
            // line 14
            echo "        <span>";
        ...
        ";
            // line 15
            if ($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerSearchEngineIcon"], "method")) {
                // line 16
                echo "            <img width=\"16\" src=\"";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerSocialNetworkIcon"], "method"), "html", null, true);
                echo "\" alt=\"";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerName"], "method"), "html", null, true);
                echo "\"/>
        ";
    ...
    ";
        ...
        // line 23
        echo "    ";
        if (($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerType"], "method") == "search")) {
            // line 24
            ...
            // line 25
            $context["showKeyword"] = ( !twig_test_empty($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerKeyword"], "method")) && ($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerKeyword"], "method") != (isset($context["keywordNotDefined"]) ? $context["keywordNotDefined"] : $this->getContext($context, "keywordNotDefined"))));
            // line 26
            echo "<span ";
        ...
        ";
            ...
            if ($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerSearchEngineIcon"], "method")) {
                // line 28
                echo "            <img width=\"16\" src=\"";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerSearchEngineIcon"], "method"), "html", null, true);
                echo "\" alt=\"";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerName"], "method"), "html", null, true);
                echo "\"/>
        ";
        ...
        ";
            ...
            ob_start();
            echo "#";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerKeywordPosition"], "method"), "html", null, true);
            $context["position"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
            // line 38
            echo "        ";
            if ($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerKeywordPosition"], "method")) {
                // line 39
                echo "            <span title='";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Live_KeywordRankedOnSearchResultForThisVisitor", (isset($context["keyword"]) ? $context["keyword"] : $this->getContext($context, "keyword")), (isset($context["position"]) ? $context["position"] : $this->getContext($context, "position")), (isset($context["searchName"]) ? $context["searchName"] : $this->getContext($context, "searchName"))]), "html", null, true);
    ...
    ";
        ...
        // line 46
        echo "    ";
        if (($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", [0 => "referrerType"], "method") == "direct")) {
...
", "@Referrers/_visitorDetails.twig", "/var/www/analytics/plugins/Referrers/templates/_visitorDetails.twig");
    }
}
