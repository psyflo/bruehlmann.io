...
class __TwigTemplate_f688b39ce6304892bd3fee19ea9ba9a27ac6ce30823c7815e6a7536b84c45437 extends \Twig\Template
{
    ...
    <div class=\"dataTableFooterNavigation\">
        ...
        if (( !(isset($context["isDataTableEmpty"]) ? $context["isDataTableEmpty"] : $this->getContext($context, "isDataTableEmpty")) && ($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_offset_information", []) || $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_pagination_control", [])))) {
            ...
            if ($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_pagination_control", [])) {
                ...
                if ($this->getAttribute((isset($context["clientSideParameters"]) ? $context["clientSideParameters"] : null), "dataTablePreviousIsFirst", [], "any", true, true)) {
        ...
        echo "            </div>
            ...
            ";
        // line 24
        if (( !(isset($context["isDataTableEmpty"]) ? $context["isDataTableEmpty"] : $this->getContext($context, "isDataTableEmpty")) && (($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_footer_icons", []) && $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_pagination_control", [])) || $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_limit_control", [])))) {
            // line 25
        ...
        if (( !twig_test_empty($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "related_reports", [])) && $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_related_reports", []))) {
            ...
            echo "}\">
                    <li><span href=\"";
            // line 33
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "self_url", []), "html", null, true);
    ...
    ";
        // line 45
        if (($this->getAttribute((isset($context["properties"]) ? $context["properties"] : null), "show_footer_message", [], "any", true, true) &&  !twig_test_empty($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_footer_message", [])))) {
            // line 46
...
<div class=\"dataTableSpacer\"></div>
", "@CoreHome/_dataTableFooter.twig", "/var/www/analytics/plugins/CoreHome/templates/_dataTableFooter.twig");
    }
}
